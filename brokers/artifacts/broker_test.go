...
func TestStartSuccessfulFlow(t *testing.T) {
	...
	m.commonBroker.AssertCalled(t, "PrintPlan", []model.PluginMeta{model.PluginMeta{ID: "testID"}})
	m.commonBroker.AssertCalled(t, "PrintInfo", "All plugins have been successfully downloaded")
